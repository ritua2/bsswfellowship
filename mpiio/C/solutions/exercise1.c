...
int main(int argc, char **argv){
  ...
  //fill the arguments of the MPI_File_Write_at function call below to pass the missing file-handle, and datatype 
  MPI_File_write_at(fhw , 0, buf, nints, MPI_INT , &status);
